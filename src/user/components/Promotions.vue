...
<!-- eslint-disable -->
	<div class="container py-5">
		<div class="row">
			<div class="col-md-9">
				<div class="row">
					<div class="col-12 col-md-6" v-for="promotion in promotions">
						<div class="card text-center py-3 mx-0 mx-md-2 mb-3">
							<div class="information-promotion pr-4 py-3 text-right">
								<div class="rounded-circle position-absolute w-45 p-2">
									<img
										width="auto"
										height="auto"
										:src="urlPublic+'promotions/'+promotion.id+'.jpg'">
								</div>
								<p class="name mb-0">
									<button
										type="button"
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel">{{promotionCurrent.name}}</h5>
						...
						<form action="">
							<div class="form-group">
								...
								<input
									...
									v-model="promotionCurrent.quantity">
							</div>
...
export default {
    ...
    methods: {
        ...
        selectPromotion(promotion) {
        	this.promotionCurrent.promotionId = promotion.id;
        	this.promotionCurrent.name = promotion.name;
        	this.promotionCurrent.price = promotion.price
        },
        addElementStore() {
        	this.$store.dispatch('addElementStore', this.promotionCurrent);
        }
    }
}
</script>
<style scoped>
	...
	.card .information-promotion div img{
		max-height: 100%;
		max-width: 100%;
	}
	.card .price{
